...
class SpindlerBatteryTest(unittest.TestCase):
    ...
    def test_should_be_serviced(self):
        spindler: SpindlerBattery = SpindlerBattery(date(2022, 7, 13), date(2025, 8, 9))
        self.assertTrue(spindler.needs_service())
        spindler = SpindlerBattery(date(2020, 10, 31), date(2024, 11, 11))
        self.assertTrue(spindler.needs_service())
        pass
    ...
    def test_should_not_be_serviced(self):
        ...
        self.assertFalse(spindler.needs_service())
        spindler = SpindlerBattery(date(2022, 9, 18), date(2024, 9, 18))
        self.assertFalse(spindler.needs_service())
        pass
